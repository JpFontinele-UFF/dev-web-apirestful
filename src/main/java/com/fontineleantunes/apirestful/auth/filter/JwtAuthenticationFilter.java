package com.fontineleantunes.apirestful.auth.filter;

import com.fontineleantunes.apirestful.auth.service.JwtService;
import com.fontineleantunes.apirestful.auth.service.UsuarioDetailsService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader != null && authHeader.startsWith(prefix)) {
            ...
            try {
                ...
                // ignore, security context won't be set
            }
        }
